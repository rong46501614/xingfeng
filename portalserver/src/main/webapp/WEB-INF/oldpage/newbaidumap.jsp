...
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=b0xVWZulQ9M7zkwobX2WGSzw">
	   ...
	   <span class="menu"> Menu</span>
		...
		<div class="banner-top">
								<ul class="nav banner-nav">                                     
										...
										<li class="dropdown1"><a class="down-scroll" >upload</a>
											<ul class="dropdown2">
												<li><a href="${pageContext.request.contextPath}/xftxItemAction_additem.do">UpLoadImg</a></li>
												<li><a href="">Support</a></li>
											</ul>
										</li> 
										<li class="dropdown1"><a class="active"  class="down-scroll"  >Maps</a>
											<ul class="dropdown2">
...
<!-- Header Ends Here -->
	<div class="domain-section">
		...
		<div class="container">
			<h4 class="domain-head">Serach Adress</h4>
							<div class="search-form domain-search">
										<div class="three-fifth domain_row column first">
											<input class="text" id="baiduMapAdress" type="text" value="搜索地址" onkeypress="getBaiduMap(event)" onFocus="cleargo5()" onBlur="go5()" onkeydown="gocolor5()">               
										</div>
	...
	<input id="hiddenb" type="hidden" value="1" />
<div class="domain">
<div style="width:5%;height:100%;float: left"></div>
<div id="container" style="width:90%;height:100%;float: left;"></div>
<script type="text/javascript"> 
	var map = new BMap.Map("container");          // 创建地图实例  
	var point = new BMap.Point(108.9542599, 34.2678777);  // 创建点坐标  
	...
	function searchAdress(){
		var local = new BMap.LocalSearch(map, {      
		      renderOptions:{
				map: map,
		    	panel:document.getElementById("result1"),
				selectFirstResult:true,
		    	autoViewport:true,
		      },

		}); 
		var searchAdress=document.getElementById("baiduMapAdress").value;
		local.search(searchAdress);
		}
	function searchBus(){
		...
		var transit = new BMap.TransitRoute(map, {    
			 renderOptions: {
				 map: map,
				 panel:document.getElementById("result2")
				 }
	...
	function BusLineSearch(){
		...
		var busline = new BMap.BusLineSearch(map,{
			...
			alert(Route);
			busline.getBusList(Route);
		}
	
	
	
		function getBaiduMap(event){
			if(event.keyCode==13){
				searchAdress();
			}
		}
