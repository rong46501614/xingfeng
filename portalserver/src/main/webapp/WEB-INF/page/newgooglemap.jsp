	   ...
	   <span class="menu"> Menu</span>
		...
		<div class="banner-top">
								<ul class="nav banner-nav">                                     
										...
										<li class="dropdown1"><a class="active"  class="down-scroll" href="">Maps</a>
											<ul class="dropdown2">
...
<!-- Header Ends Here -->
	<div class="domain-section">
		...
		<div class="container">
			<h4 class="domain-head">Serach GoogleMap</h4>
...
<div id="googleMap" style="width:90%;height:100%;float: left;"></div>
<script>
      function initMap() {
        var mapDiv = document.getElementById('googleMap');
        var map = new google.maps.Map(mapDiv, {
            center: new google.maps.LatLng(34.2588777,108.9462599),
            zoom: 15,
    ...
    <script async defer
        src="https://ditu.gdgdocs.org/maps/api/js?key=AIzaSyAE-9ljgxlTggrWXxxC9sifJDOJAH00g-g&callback=initMap">
    </script>
