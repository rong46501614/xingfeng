...
<!-- #Testimonials -->
				...
				<div class="row">
					<div class="col-md-2 col-md-offset-1">
						<div id="testimonialPicture">
							<img src="<s:property value='%{#session.xftxUser.userimg}'/>" style="width: 182px;height: 182px;border-radius: 190px;">
							<div style="width: 100%;height: 10%;"></div>
							<input type="button" value="修改头像" style="width: 50%;height: 20%;margin-left: 25%;" onclick="window.location.href='xftxUserAction_img.do'">
						</div>
					</div>
					<div class="col-md-7 col-md-offset-1">
						<h2><s:property value='%{#session.xftxUser.userlogin}'/></h2>
						<h3>密码：<s:property value='%{#session.xftxUser.userpasswd}'/></h3>
						<h3>签名：<s:property value='%{#session.xftxUser.userabout}'/></h3>
					</div>
					<div class="clearfix"></div>
				</div>
			</div>
	...
	<div class="hd-content">
		<div class="container">
			...
			<div class="one_third last feature" onclick="window.location.href='xftxUserAction_userinfo.do'">
				<i class="icon-gear"></i>
				<h6>完善信息</h6>
				<p>Lorem ipsum dolor sit amet, con sectetur adipiscing elit. Vivamus dignissim sodales nis facilisis adipiscing dolor sit amet.</p>
			</div>
