...
<!-- #Testimonials -->
		<div id="testimonialWrapper" style="background-color: #c0c0c0;width: 100%;height: 100%;">
			...
			<div style="width: 100%;">
				<div style="font-size: 20px;margin-bottom: 20px;width: 40%;height:9%;float: left;">
					<table style="width: 100%;height: 100%;">
						<tr style="width: 100%;height: 100%;text-align: right;"><td>登录账号：</td></tr>
					</table>
				</div>
				<div style="text-align: left;font-size: 16px;margin-bottom: 20px;width: 60%;height:9%;float: left;">
					<table style="width: 100%;height: 100%;">
						<tr style="width: 100%;height: 100%;text-align: left;"><td><s:property value='%{#session.xftxUser.userlogin}'/></td></tr>
					</table>
			...
			<div style="width: 100%;">
				<div style="font-size: 20px;margin-bottom: 20px;width: 40%;height:9%;float: left;">
					<table style="width: 100%;height: 100%;">
						<tr style="width: 100%;height: 100%;text-align: right;"><td>用户名：</td></tr>
					</table>
				</div>
				<div style="text-align: left;font-size: 20px;margin-bottom: 20px;width: 60%;height:9%;float: left;">
					<input type="text" style="background: none;border: 1px solid #000000;width: 60%;height: 100%;">
				</div>
			</div>
			<div style="width: 100%;">
				<div style="font-size: 20px;margin-bottom: 20px;width: 40%;height:9%;float: left;">
					<table style="width: 100%;height: 100%;">
						<tr style="width: 100%;height: 100%;text-align: right;"><td>性别：</td></tr>
					</table>
				</div>
				<div style="text-align: left;font-size: 20px;margin-bottom: 20px;width: 60%;height:9%;float: left;">
					<input type="text" style="background: none;border: 1px solid #000000;width: 60%;height: 100%;">
			...
			<div style="width: 100%;">
				<div style="font-size: 20px;margin-bottom: 20px;width: 40%;height:9%;float: left;">
					<table style="width: 100%;height: 100%;">
						<tr style="width: 100%;height: 100%;text-align: right;"><td>生日：</td></tr>
					</table>
				</div>
				<div style="text-align: left;font-size: 20px;margin-bottom: 20px;width: 60%;height:9%;float: left;">
					<input type="text" style="background: none;border: 1px solid #000000;width: 60%;height: 100%;">
			...
			<div style="width: 100%;">
				<div style="font-size: 20px;margin-bottom: 20px;width: 40%;height:9%;float: left;">
					<table style="width: 100%;height: 100%;">
						<tr style="width: 100%;height: 100%;text-align: right;"><td>所在城市：</td></tr>
					</table>
				</div>
				<div style="text-align: left;font-size: 20px;margin-bottom: 20px;width: 60%;height:9%;float: left;">
					<input type="text" style="background: none;border: 1px solid #000000;width: 60%;height: 100%;">
			...
			<div style="width: 100%;">
				<div style="font-size: 20px;margin-bottom: 40px;width: 40%;height:9%;float: left;">
					<table style="width: 100%;height: 100%;">
						<tr style="width: 100%;height: 100%;text-align: right;"><td>个人简介：</td></tr>
					</table>
				</div>
				<div style="text-align: left;font-size: 20px;margin-bottom: 40px;width: 60%;height:9%;float: left;">
					<input type="text" style="background: none;border: 1px solid #000000;width: 60%;height: 100%;">
				</div>
			</div>
			<div style="width: 100%;">
				<div style="font-size: 20px;margin-bottom: 20px;width: 40%;height:9%;float: left;">
					<table style="width: 100%;height: 100%;">
						<tr style="width: 100%;height: 100%;text-align: right;"></td></tr>
					</table>
				</div>
				<div style="text-align: center;font-size: 20px;margin-bottom: 40px;width: 60%;height:9%;float: left;">
	...
	<div class="hd-content">
		<div class="container">
			...
			<div class="one_third feature"  onclick="window.location.href='xftxMountainsAction_useritem.do'">
