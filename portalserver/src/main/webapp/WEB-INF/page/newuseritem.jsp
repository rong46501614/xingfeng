	...
	<s:if test="%{#request.list!=null && #request.list.size()>0}">
		<s:iterator value="%{#request.list}" var="xftxItemForm">
			...
			<%if(i%3==2){%><div class="col-md-4 one_third last pricing"><%}else{%><div class="col-md-4 one_third pricing"><%} i++;%>
				<img src="images/close.png" style="width: 10%;margin: 0;left:90%;padding: 0;position: absolute;" id="<s:property value='%{#xftxItemForm.itemId}'/>" onclick="closeitem(this)">
				...
				<div class="pricing_bottom">
					<a href="${pageContext.request.contextPath}/xftxMountainsAction_touseritemshow.do?itemId=<s:property value='%{#xftxItemForm.itemId}'/>">详情/details</a>
				</div>
			</div>
