	...
	<div class="login-content">
		...
		<div class="login-page">
			   ...
			   <div class="col-md-6 login-left wow fadeInLeft" data-wow-delay="0.4s">
				 ...
				 <a class="acount-btn" href="${pageContext.request.contextPath}/xftxUserAction_register.do">Create an Account</a>
			   </div>
			   <div class="col-md-6 login-right wow fadeInRight" data-wow-delay="0.4s">
			  	<h3>REGISTERED CUSTOMERS</h3>
				<p>If you have an account with us, please log in.</p>
				<form action="${pageContext.request.contextPath}/xftxUserAction_loginCL.do" method="post">
				  <div>
					<span>UserLogin Email/PhoneNum<label>*</label></span>
					<input id="userlogin" name="userLogin" class="input_1" type="text" style="border: 1px solid #4e4e4e" value="请输入手机号/邮箱" onFocus="cleargo2()" onBlur="go2()" onkeydown="gocolor2()"> 
				  </div>
				  <div>
