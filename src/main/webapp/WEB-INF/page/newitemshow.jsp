		...
		xhr.onreadystatechange = function(){
			if(xhr.readyState==4){
				if(xhr.status==200){
					...
					var imgshowsdiv=imgshows.getElementsByTagName("div");
					
					var date=JSON.parse(xhr.responseText);
					for(var i=0;i<date.length;i++){
						var k = getimgdiv();
						var imgshowk=imgshowsdiv[k];
	...
	<div id="maskLayer" class="maskLayer" style="display: none;position: absolute;z-index: 1009" >
		...
		<div id="criticism" style="width: 30%;height: 100%;float: left;">
			...
			<div style="width: 89%;height: 10%;float: left;border-bottom: 1px solid #686868;">
				...
				<input type="text" id="input_desc" onclick="desc()" value="我也来说说..." style="font-size:12px;height:50%; background:none;border: 1px solid #686868;border-radius: 5px;">
